...
tokenizer = AutoTokenizer.from_pretrained("path_to_trained_ppo_model_tokenizer")
model = AutoModelForCausalLM.from_pretrained("path_to_trained_ppo_model").to(device)
