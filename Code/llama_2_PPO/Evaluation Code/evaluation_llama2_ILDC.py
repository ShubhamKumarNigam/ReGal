...
import pandas as pd
df1=pd.read_csv("llama2_ppo_inference_ILDC_data.csv")
df2=pd.read_csv("PPO-ILDC-Llama2-Result_compare-vanilla-and-ppo.csv")
...
import json
with open("ildc-ppo_Evaluation_Scores_LawRL", "w") as outfile:
