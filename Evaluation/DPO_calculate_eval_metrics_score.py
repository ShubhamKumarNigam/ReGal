...
df = pd.read_csv("REGAL_EVAL_DATASET/new_regal_trained_DPO_model_test_infer_1024_maxtokens.csv")  # Load your dataframe if not already loaded
...
df.to_csv('evaluated_output_with_avg_DPO.csv', index=False)  # Save to a new CSV file
