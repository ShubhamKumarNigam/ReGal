...
df = pd.read_csv("REGAL_EVAL_DATASET/llama_3.2_vanilla_infer_Over_predex_Test_merged.csv")  # Load your dataframe if not already loaded
...
df.to_csv('evaluated_output_with_avg_vanilla.csv', index=False)  # Save to a new CSV file
